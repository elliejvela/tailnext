    ...
    <div className="mx-auto max-w-7xl">
      <div className={`md:flex ${isReversed ? 'md:flex-row-reverse' : ''} md:gap-16`}>
        <div className="self-center md:basis-1/2">
          {content && <div className="mb-8 lg:mb-12 text-lg text-[#1F0024]/80 dark:text-slate-400">{content}</div>}
          <ItemGrid
            items={items}
            columns={1}
            ...
            titleClass="text-lg font-medium leading-6 text-[#1F0024] dark:text-white mt-1 mb-2"
