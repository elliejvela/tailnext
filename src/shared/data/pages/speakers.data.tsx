...
export const speakerInfo: speakerInfoProps = {
  items: [
    ...
    },
    {
      ...
      bio: (
        <div className="space-y-4">
          ...
          <p>Briggs earned his undergraduate degree as a scholarship athlete at Texas Christian University, where he joined Omega Psi Phi Fraternity. He later obtained a Master's Degree from Florida A&M University and a law degree with honors from FSU College of Law.</p>
    ...
    },
    {
      ...
      bio: (
        <div className="space-y-4">
          <p className='bg-yellow-300'>Michael Widell MBA is a seasoned leader in higher education, innovation, and workforce development experience across</p>
